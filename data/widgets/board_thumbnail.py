...
class BoardThumbnail(_Widget):
    def __init__(self, relative_position, width, fen_string=''):
        super().__init__()
    ...
    def set_screen_size(self, new_screen_size):
        ...
        self._board.set_screen_size(new_screen_size)
        self._piece_group.handle_resize((0, 0), self._size, resize_end=False) # ONLY RENDERS PIECES IN LOW QUALITY
