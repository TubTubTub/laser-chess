import pygame
from data.constants import OVERLAY_COLOUR_LIGHT, OVERLAY_COLOUR_DARK
from data.utils.board_helpers import coords_to_screen_pos, screen_pos_to_coords, create_square_overlay, create_circle_overlay
...
class OverlayDraw:
    ...
    def draw(self, screen):
        ...
        if self._hovered_coords and self._available_coords:
            if self._hovered_coords not in self._available_coords:
                return
