...
\lstinputlisting{../../data/assets.py}
\label{src:data/assets.py}

\subsection{constants.py}
\lstinputlisting{../../data/constants.py}
...
\lstinputlisting{../../data/__init__.py}
...
\subsection{\_\_init\_\_.py}
\lstinputlisting{../../data/states/__init__.py}
...
\subsection{arena.py}
\lstinputlisting{../../data/states/game/cpu/arena.py}
...
\lstinputlisting{../../data/states/game/cpu/engines/iterative_deepening.py}
