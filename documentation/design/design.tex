...
\noindent To implement shadow casting for my 2D game, I have modified some steps and arrived at the final following workflow:
...
\noindent View \href{https://nbviewer.org/github/TubTubTub/laser-chess/blob/main/documentation/design/assets/widgets_class_diagram.pdf}{complete class diagram for all widgets.}

\noindent View \href{https://nbviewer.org/github/TubTubTub/laser-chess/blob/main/documentation/design/assets/all_class_diagram_1.pdf}{complete class diagram for entire program.}

\noindent View \href{https://nbviewer.org/github/TubTubTub/laser-chess/blob/main/documentation/design/assets/all_class_diagram_2.pdf}{alternate class diagram for entire program.}
